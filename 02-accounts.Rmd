...
If everything is green as shown below, you are ready to proceed.
...
If you see anything in red as shown below, click the link to e-mail SciComp ([scicomp\@fredhutch.org](mailto:scicomp@fredhutch.org)) to finish setting up your account. Be sure to include your HutchNetID and PI name in the email.
