...
2.  PuTTY should now be available in your applications. Click on PuTTY to open.
...
3.  You should now see the PuTTY Configuration menu.
  ...
  In the next chapter (Logging In), you will enter the Host Name to log into the Cluster.
