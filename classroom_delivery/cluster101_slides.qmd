...
-   How to access pre-installed software on the cluster
...
-   **Working** for secondary working copies of the data for analysis. You can find it at `/fh/working`.
...
## Interactive sessions on compute note and loading in software

Walk through: <https://hutchdatascience.org/FH_Cluster_101/interactive-session.html>

Walk through: [https://sciwiki.fredhutch.org/scicomputing/compute_environments/](https://sciwiki.fredhutch.org/scicomputing/compute_environments/https://sciwiki.fredhutch.org/scicomputing/compute_environments/)

## Submit Your First Job

Walk through: <https://hutchdatascience.org/FH_Cluster_101/submit-a-computing-script.html>
...
Remember to load the necessary software via `module load`!
...
<https://forms.gle/MbWq5DmiZJHDm6yR9>

## Additional Resources

-   [Bash for Bioinformatics course](https://docs.google.com/forms/d/e/1FAIpQLSdAoM4Mi3XSLFZMnieB3HK6j-gIWPR0fyHEXZEw34YODKLdhg/viewform) starts next week!

-   [SciWiki](https://sciwiki.fredhutch.org/)

-   Scientific Computing Office Hours on Wednesday 10am-Noon: on Q&A channel on [Fred Hutch Data Slack](https://join.slack.com/t/fhdata/signup).

-   [Data House Calls with DaSL](https://ocdo.fredhutch.org/programs/dhc.html)
